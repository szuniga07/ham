...
```{r lrm}
# Model summary
summary(assess(am ~ hp+wt, data=mtcars, regression="logistic"))
```
...
In this example, we examine the Hospital Acquired Infection rate over 3+ years.
...
```{r pm1_interpret}
# Specify how many significant digits with digits argument
  interpret(summary(assess(HAI ~ Month + offset(log(PatientDays)),
